...
__Explores if there difference with respect to IBU and ABV between IPAs (India Pale Ales) and other types of Ale using two different classification technique.__
...
dfBeers = read.csv("/media/andrew/29426984-e707-487c-8f66-ca5e368b23d1/Documents/School/HomeWork/DS6306_DDS/MSDS_6306_Doing-Data-Science/GItRepos/DS_6306/RawDataFiles/Beers.csv",header = TRUE)

dfBreweries = read.csv("/media/andrew/29426984-e707-487c-8f66-ca5e368b23d1/Documents/School/HomeWork/DS6306_DDS/MSDS_6306_Doing-Data-Science/GItRepos/DS_6306/RawDataFiles/Breweries.csv",header = TRUE)

us_states = read.csv('/media/andrew/29426984-e707-487c-8f66-ca5e368b23d1/Documents/School/HomeWork/DS6306_DDS/MSDS_6306_Doing-Data-Science/GItRepos/DS_6306/RawDataFiles/states.csv', header = TRUE)
...
__Question of Interest: s there an apparent relationship between the bitterness of the beer and its alcoholic content? Draw a scatter plot.  Make your best judgment of a relationship?__
